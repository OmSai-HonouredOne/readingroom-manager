...
def sendReminder(query_all, execute, app):
    ...
    emails = query_all("SELECT email FROM students WHERE reminder_time >= NOW() AT TIME ZONE 'Asia/Kolkata' - INTERVAL '20 minutes'")
    ...
    try:
        ...
        pass
    execute('UPDATE students SET reminder_time = NULL WHERE reminder_time IS NOT NULL')